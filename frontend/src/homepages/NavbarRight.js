...
const NavbarRight = () => (
  <section id="navbarRight">
    ...
    {/* <div>
        <div className="bg-teal-200 max-w-sm rounded overflow-hidden shadow-lg">
          <div className="font-bold text-xl">
            U.N.<br></br>Lang-<br></br>uages:
          </div>
        </div>
      </div>

      <div className="py-2">
        <div className="flex bg-indigo-900 text-white max-w-sm rounded overflow-hidden shadow-lg">
