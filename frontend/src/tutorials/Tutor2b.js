...
function Tutor2b() {
  const str201 = "mkdir DjangoReactJS1";
  const copy201 = (
  ...
  const str202 = "cd DjangoReactJS1";
  const copy202 = (
  ...
  const str212 = "npx create-react-app frontend";
  const copy212 = (
  ...
  const str213 = "yarn create react-app frontend";
  const copy213 = (
  ...
  const str225 = "cd DjangoReactJS1/project1";
  const copy225 = (
  ...
  const str321 =
    "npm install --save redux react-redux redux-thunk redux-devtools-extension rebass rebass @heroicons/react react-intl vuera axios react@latest chokidar string-strip-html emailjs-com react-paginate react-syntax-highlighter web-vitals react-dom @emailjs/browser react-router-dom @types/react-router-dom";
  const copy321 = (
  ...
  const str322 =
    "npm install @paypal/react-paypal-js react-textarea-autosize react-icons react-easy-swipe classnames react react-dom react-hook-form @headlessui/react luxon @chec/commerce.js chec__commerce.js @stripe/react-stripe-js @stripe/stripe-js prop-types jest react styled-components styled-system styled-system__css";
  const copy322 = (
  ...
  const str323 =
    "npm install -- reactjs-social-login react-copy-to-clipboard save supabase-comments-extension @supabase/ui @supabase/supabase-js react-query react-audio-player @paypal/paypal-js uuid @chec/react-commercejs-hooks";
  const copy323 = (
  ...
  const str325 =
    "npm i --save-dev node prop-types luxon @testing-library/jest-dom @testing-library/user-event  @testing-library/dom @testing-library/react react-syntax-highlighter react-copy-to-clipboard rebass rebass @heroicons/react";
  const copy325 = (
  ...
  return (
    <div id="tutor2b" className="py-5 px-10 text-xl">
      <section id="">
      ...
      <h1 className="mt-4 mb-4 title-font bg-green-600 font-bold text-white">
        Creating a Website using Django/React/TailwindCSS
      </h1>
      <ul className="list-disc">
        <li className="text-b0ld">
      ...
      <ol className="list-decimal">
        ...
        <li>
          Open the DjangoReactJS1 folder in VS Code (e.g. Launch VS Code, click
      ...
      <ol className="list-decimal">
        ...
        <li>
          You must install both [react-router-dom] and [react-router-dom] as
          well as both [rebass] and [rebass] while using [react-typescript]: npm
          install --save redux react-redux redux-thunk redux-devtools-extension
          rebass rebass @heroicons/react react-intl vuera axios react@latest
          chokidar string-strip-html emailjs-com react-paginate
          react-syntax-highlighter web-vitals react-dom @emailjs/browser
          react-router-dom @types/react-router-dom ([@types] because we are
          using Typescript)
        </li>
        ...
        <li>
          ...
          chec__commerce.js @stripe/react-stripe-js @stripe/stripe-js prop-types
          jest react styled-components styled-system styled-system__css
        </li>
        ...
        <li>
          ...
          react-query react-audio-player @paypal/paypal-js uuid
        ...
        <li>
          npm i --save-dev node prop-types luxon @testing-library/jest-dom
          @testing-library/user-event @testing-library/dom
          @testing-library/react react-syntax-highlighter
      ...
      <ol className="list-decimal">
        ...
        <li>
          ...
          <code>~\DjangoReactJS1\project1\frontend&lt;npm start</code> because
          of CORS_ORIGIN_WHITELIST = ['https://localhost:3000',]
        </li>
      </ol>
      <h1 className="mt-4 mb-4 title-font bg-green-600 font-bold text-white">
      ...
      <ol className="list-decimal">
        ...
        <li>
          ...
          <ol className="list-decimal">
            <li>
              The [DjangoReactJS1] folder contain all the contents of the
              website project.
            </li>
            <li>
            ...
            <li>
              Open the [DjangoReactJS1] folder in a code editor of your choice,
