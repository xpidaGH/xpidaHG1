...
function Tutor2a() {
  ...
  const str225 = "cd ReactJS1/project1";
  const copy225 = (
  ...
  return (
    <div id="tutor2a" className="py-5 px-10 text-xl">
      <section id="">
      ...
      <ol className="list-decimal">
        ...
        <li>
          Open the ReactJS1 folder in VS Code (e.g. Launch VS Code, click File,
          click Open Folder... )
        </li>
      ...
      <ol className="list-decimal">
        ...
        <li>
          ...
          <code>~\ReactJS1\project1\frontend&lt;npm start</code> because of
          CORS_ORIGIN_WHITELIST = ['https://localhost:3000',]
        </li>
      </ol>
      <h1 className="mt-4 mb-4 title-font bg-green-600 font-bold text-white">
      ...
      <ol className="list-decimal">
        ...
        <li>
          ...
          <ol className="list-decimal">
            <li>
              The [ReactJS1] folder contain all the contents of the website
              project.
            </li>
            <li>
            ...
            <li>
              Open the [ReactJS1] folder in a code editor of your choice, such
