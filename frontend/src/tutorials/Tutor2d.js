...
function Tutor2d() {
  const str201 = "mkdir DjangoReactTS";
  const copy201 = (
  ...
  const str225 = "cd DjangoReactTS/project1";
  const copy225 = (
  ...
  return (
    <div id="tutor2d" className="py-5 px-10 text-xl">
      <section id="">
      ...
      <ol className="list-decimal">
        ...
        <li>
          Open the DjangoReactTS folder in VS Code (e.g. Launch VS Code, click
      ...
      <ol className="list-decimal">
        ...
        <li>
          ...
          <code>~\DjangoReactTS\project1\frontend&lt;npm start</code> because of
          CORS_ORIGIN_WHITELIST = ['https://localhost:3000',]
        </li>
      </ol>
      <h1 className="mt-4 mb-4 title-font bg-green-600 font-bold text-white">
      ...
      <ol className="list-decimal">
        ...
        <li>
          ...
          <ol className="list-decimal">
            <li>
              The [DjangoReactTS] folder contain all the contents of the website
              project.
            </li>
            <li>
            ...
            <li>
              Open the [DjangoReactTS] folder in a code editor of your choice,
